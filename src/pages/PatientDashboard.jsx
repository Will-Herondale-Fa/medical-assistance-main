...
const PatientDashboard = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_right,_rgba(47,143,131,0.16)_0%,_rgba(255,248,238,1)_35%,_rgba(246,239,228,1)_72%,_rgba(243,236,225,1)_100%)] p-6 md:p-10">
      <div className="absolute -top-10 left-0 h-96 w-96 rounded-full bg-[#93c5fd] mix-blend-multiply blur-3xl opacity-45 animate-blob"></div>
      <div className="absolute top-10 right-0 h-96 w-96 rounded-full bg-[#5eead4] mix-blend-multiply blur-3xl opacity-45 animate-blob animation-delay-2000"></div>
      <div className="absolute bottom-0 left-20 h-96 w-96 rounded-full bg-[#bae6fd] mix-blend-multiply blur-3xl opacity-45 animate-blob animation-delay-4000"></div>

      <div className="relative mx-auto max-w-6xl rounded-[2rem] border border-[#dbeafe] bg-white/72 p-6 shadow-2xl backdrop-blur-xl md:p-10">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <p className="text-sm uppercase tracking-[0.25em] text-[#1e3a8a] font-semibold">Medibot Patient</p>
        ...
        <div className="flex flex-col items-center justify-center py-12 md:py-20">
          ...
          <div className="relative mt-12 flex items-center justify-center">
            <div className="absolute h-80 w-80 rounded-full bg-[#93c5fd]/35 blur-3xl animate-pulse"></div>
            <div className="absolute h-64 w-64 rounded-full border border-[#bfdbfe]/60 animate-ping"></div>
            <div className="absolute h-80 w-80 rounded-full border border-[#5eead4]/70 animate-[spin_18s_linear_infinite]"></div>
            ...
            <button
              ...
              className="relative z-10 flex h-56 w-56 flex-col items-center justify-center gap-3 rounded-full bg-gradient-to-br from-[#2563eb] via-[#b36a4b] to-[#0f766e] text-xl font-black text-white shadow-[0_25px_80px_rgba(120,85,60,0.42)] transition-all duration-300 hover:scale-105 active:scale-95 disabled:cursor-not-allowed disabled:opacity-55 disabled:hover:scale-100 md:h-64 md:w-64 md:text-2xl"
            >
          ...
          {consultationLink ? (
            <div className="mt-8 w-full max-w-3xl rounded-2xl border border-[#dbeafe] bg-white/85 p-4 shadow-lg">
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                ...
                {isJitsiEmbeddedMode ? (
                  <button
                    ...
                    className="rounded-lg border border-[#b9dfd8] bg-[#edf9f6] px-4 py-2 text-sm font-semibold text-[#0f766e] hover:bg-[#dff1ed]"
                  >
