      ...
      <div className="relative mx-auto max-w-6xl rounded-[2rem] border border-cyan-100 bg-white/70 p-6 shadow-2xl backdrop-blur-xl md:p-10">
        ...
        <div className="flex flex-col items-center justify-center py-12 md:py-20">
          ...
          <div className="relative mt-12 flex items-center justify-center">
            <div className="absolute h-80 w-80 rounded-full bg-cyan-300/35 blur-3xl animate-pulse"></div>
            <div className="absolute h-64 w-64 rounded-full border border-cyan-300/60 animate-ping"></div>
            <div className="absolute h-80 w-80 rounded-full border border-emerald-200/70 animate-[spin_18s_linear_infinite]"></div>
            ...
            >
              ...
              <span className="text-sm md:text-base font-medium text-cyan-50/90">
